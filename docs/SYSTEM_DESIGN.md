...
> truth is now [`docs/PLATFORM.md`](PLATFORM.md) (Part I + Part II). Do not edit this file.
...
>
> **See also:** `ARCHITECTURE.md` (end-to-end system framework & domain model of record),
> `LOGIC.md` (per-entity contracts), `SYSTEM_MAP.md` (source requirements).

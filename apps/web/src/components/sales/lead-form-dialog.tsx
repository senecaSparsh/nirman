  ...
  return (
    <form onSubmit={submit} className="space-y-3">
      ...
      <div className="space-y-3.5">
        ...
        <Textarea id="lead-notes" value={form.notes} onChange={(event) => set("notes", event.target.value)} rows={2} />
      </div>
...
export function LeadFormDialog({
  ...
  return (
    <Dialog
      ...
      size="lg"
    >
      <LeadForm projects={projects} units={units} assignees={assignees} onDone={() => onOpenChange(false)} />
    </Dialog>
  );
}

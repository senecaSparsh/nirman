    ...
    >
      <form onSubmit={onSubmit} className="space-y-3">
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <Field label="Economic Order Qty (EOQ)" error={errors.economicOrderQty} hint="Optimal order quantity per reorder">
            <InputWithUnit
              type="number"
              step="0.001"
              min="0"
          ...
          <Field label="Lot Tracked">
            <label className="flex h-9 items-center gap-2 text-body">
              <input
                ...
                className="h-4 w-4 shrink-0 rounded border-border"
              />
              <span className="text-muted-foreground whitespace-nowrap">Enable batch/lot compliance</span>
            </label>
          </Field>
          <Field label="Scrap Material">
            <label className="flex h-9 items-center gap-2 text-body">
              <input
                ...
                className="h-4 w-4 shrink-0 rounded border-border"
              />
              <span className="text-muted-foreground whitespace-nowrap">Internally generated by-product</span>
            </label>
          </Field>
        </div>

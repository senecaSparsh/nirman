...
// Client-boundary component — lives in its own file because server detail
// pages render these primitives with `icon: LucideIcon` props, which cannot
// cross a client boundary.
export { DetailPrintButton } from "./detail-print-button";
...
// DetailPrintButton moved to ./detail-print-button (client boundary — see
// the re-export at the top of this file).

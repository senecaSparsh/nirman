...
function mbColumnsWithActions(
  onAction: (id: string, action: "verify" | "approve" | "reject") => void,
  canVerify: boolean,
  canApprove: boolean,
): Column<MbEntry>[] {
  return [
    ...
    <div className="space-y-4">
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          description="Record actual quantities executed on site. Entries go through Draft → Verified → Approved, then get included in RA Bills from the work order page."
          action={canCreate ? (
        ...
        <div className="rounded-lg border border-border overflow-hidden">
          <DataTable
            ...
            columns={(canVerify || canApprove) ? mbColumnsWithActions(onAction, !!canVerify, !!canApprove) : mbColumns}
            searchable
...
function MbEntryDialog({
  ...
  return (
    <Dialog
      ...
      description="Record actual quantities executed on site. Entries start as Draft, get Verified, then Approved. Approved entries are included in RA Bills from the work order page."
      className="max-w-2xl"
    >

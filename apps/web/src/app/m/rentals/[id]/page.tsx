    ...
    <MobileDetailPage params={params}>
      {async ({ id, company, role }) => {
        ...
        const data = {
          ...
          rentAgreementDocumentUrl: tenancy.rentAgreementDocumentUrl,
          rentAgreementDocumentName: tenancy.rentAgreementDocumentName,
          notes: tenancy.notes,
          rentFreeDays: tenancy.rentFreeDays,
          sacCode: tenancy.sacCode,
          escalationPercent: tenancy.escalationPercent ? toNum(tenancy.escalationPercent) : null,
          escalationIntervalMonths: tenancy.escalationIntervalMonths,
          draftNotes: tenancy.draftNotes,
          draftDate: tenancy.draftDate ? tenancy.draftDate.toISOString() : null,
          totalReceived,
          totalExpectedRent,
          overdueAmount,

...
async function MobileEmployeeDetailContent({
  ...
  const data = {
    ...
    // narrower than the docs tier: hr.manage only (canSeeSigningTokens). A
    // payroll.manage holder gets bank/docs but never the signing links.
    ...
    contractToken: accessScope.canSeeSigningTokens ? employee.contractToken : null,
    ...
    offerToken: accessScope.canSeeSigningTokens ? employee.offerToken : null,
    ...
    dateOfBirth: accessScope.canSeePersonalDocs && employee.dateOfBirth ? employee.dateOfBirth.toISOString() : null,
    bloodGroup: employee.bloodGroup,
    photoUrl: employee.photoUrl,
    autoDepositEnabled: accessScope.canSeePayroll ? employee.autoDepositEnabled : false,
    autoDepositSetupAt: accessScope.canSeePayroll && employee.autoDepositSetupAt ? employee.autoDepositSetupAt.toISOString() : null,
  ...
  const onboardingData: OnboardingEmployeeData = {
    ...
    bloodGroup: employee.bloodGroup,
    photoUrl: employee.photoUrl,
    // Employment terms — dossier tier alongside wages.
    employmentType: accessScope.canSeePayroll ? employee.employmentType : null,
    probationEndDate: accessScope.canSeePayroll && employee.probationEndDate ? employee.probationEndDate.toISOString() : null,
    confirmationDate: accessScope.canSeePayroll && employee.confirmationDate ? employee.confirmationDate.toISOString() : null,
    noticePeriodDays: accessScope.canSeePayroll ? employee.noticePeriodDays : null,
    contractStartDate: accessScope.canSeePayroll && employee.contractStartDate ? employee.contractStartDate.toISOString() : null,
    contractEndDate: accessScope.canSeePayroll && employee.contractEndDate ? employee.contractEndDate.toISOString() : null,
    autoDepositEnabled: accessScope.canSeePayroll ? employee.autoDepositEnabled : false,

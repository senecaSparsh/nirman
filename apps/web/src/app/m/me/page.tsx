...
export default function MePage() {
  ...
  const [userEmployeeCode, setUserEmployeeCode] = useState<string | null>(null);
  const [userDesignation, setUserDesignation] = useState<string | null>(null);
  const [userDepartment, setUserDepartment] = useState<string | null>(null);
  const [userJoiningDate, setUserJoiningDate] = useState<string | null>(null);
  const [userLastLoginAt, setUserLastLoginAt] = useState<string | null>(null);

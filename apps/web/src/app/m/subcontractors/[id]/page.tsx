...
export default function MobileSubcontractorDetailPage({
  ...
  return (
    <Suspense fallback={<PageLoading label="Loading subcontractor…" />}>
      <MobileSubcontractorDetailContent params={params} />
    </Suspense>
  );
}

async function MobileSubcontractorDetailContent({
  params,
}: {
  params: Promise<{ id: string }>;
}) {

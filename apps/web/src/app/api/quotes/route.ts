...
export const GET = apiHandler(async (req: NextRequest) => {
  ...
  return json({
    ...
    quotes: statement.quotes.map((q) => ({
      ...
      buyerTransportTotal: toNum(q.buyerTransportTotal),
      paymentTerms: q.paymentTerms,
      leadTimeDays: q.leadTimeDays,
      warranty: q.warranty,
      subtotal: toNum(q.subtotal),
      gstTotal: toNum(q.gstTotal),
      freightTotal: toNum(q.freightTotal),
      loadingTotal: toNum(q.loadingTotal),
      packingTotal: toNum(q.packingTotal),
      insuranceTotal: toNum(q.insuranceTotal),
      discountTotal: toNum(q.discountTotal),
      handlingTotal: toNum(q.handlingTotal),
      lines: q.lines.map((l) => ({
        id: l.id,
        ...
        discountPerUnit: toNum(l.discountPerUnit),
        packingPerUnit: toNum(l.packingPerUnit),
        freightPerUnit: toNum(l.freightPerUnit),
        loadingPerUnit: toNum(l.loadingPerUnit),
        insurancePerUnit: toNum(l.insurancePerUnit),
        handlingPerUnit: toNum(l.handlingPerUnit),
        buyerTransportPerUnit: toNum(l.buyerTransportPerUnit),
        unitLandedCost: toNum(l.unitLandedCost),
        taxableValue: toNum(l.taxableValue),

...
export default async function AcceptAgreementPage({
  ...
  if (expired) {
    return (
      <div className="min-h-dvh grid place-items-center p-6 bg-gray-50">
        <div className="max-w-md text-center space-y-2">
          <p className="text-lg font-bold text-gray-900">This agreement link has expired</p>
          <p className="text-sm text-gray-500">
            Agreement links are valid for {LINK_TTL_DAYS} days. Ask your HR contact to re-issue it.
          </p>
        </div>
      </div>
    );

...
export const ROUTES: RouteEntry[] = [
  ...
  { path: "/m/books/payroll", title: "Payroll Ledger", parent: "/m/accounts", kind: "list", module: "accounts", perm: "payroll.view", icon: Landmark, hint: "Payroll periods, salary breakdown", personas: ["executive", "finance"], desktopPath: "/hr/payroll" },
  { path: "/m/books/receipts", title: "Receipts Ledger", parent: "/m/accounts", kind: "list", module: "accounts", perm: "finance.view", icon: Receipt, hint: "Payment receipts — asset & material sales", personas: ["executive", "finance"], sharesListWith: ["/m/accounts"], desktopPath: "/finance" },
  { path: "/m/books/receipts/[id]", title: "Receipt", parent: "/m/books/receipts", kind: "detail", module: "accounts", perm: "finance.view", icon: Receipt, desktopPath: "/finance" },
  { path: "/m/books/reports", title: "Analytics", parent: "/m/accounts", kind: "list", module: "accounts", perm: "finance.view", icon: BarChart3, hint: "Key metrics at a glance", personas: ["executive", "ops", "finance"], desktopPath: "/reports" },
  ...
  // Desktop has no standalone /hr/onboarding — onboarding lives inside the
  // employee roster/profile, so mobile onboarding routes land there.
  ...
  { path: "/m/pulse", title: "Executive Dashboard", parent: "/m/home", kind: "hub", module: "home", perm: "projects.view", icon: Sun, hint: "Portfolio KPIs, project health, approvals", desktopPath: "/" },
  ...
  { path: "/m/site/issue", title: "Issue", parent: "/m/site", kind: "list", module: "home", perm: "stock.issue", icon: ArrowLeftRight, hint: "Issue stock to projects and departments", redirectTo: "/m/stock-out?mode=issue", desktopPath: "/stock", flowId: "materialIssue" },
  { path: "/m/site/me", title: "My Profile", parent: "/m/site", kind: "list", module: "home", icon: User, hint: "Supervisor profile — attendance, DPRs, tasks", personas: ["executive", "ops", "hr", "field"], desktopPath: "/me" },
  { path: "/m/site/receive", title: "Receive", parent: "/m/site", kind: "list", module: "home", perm: "procurement.view", icon: Package, hint: "In-transit POs — jump straight into barcode receiving", redirectTo: "/m/site/field", desktopPath: "/field" },
  { path: "/m/site/stock", title: "Site Stock", parent: "/m/site", kind: "list", module: "home", perm: "inventory.view", icon: Package, hint: "Stock by site + movements", personas: ["executive", "ops", "procurement", "field"], desktopPath: "/stock" },
  { path: "/m/site/tasks", title: "Tasks", parent: "/m/site", kind: "list", module: "home", perm: "tasks.view", icon: ClipboardCheck, hint: "Tasks assigned to you, with steps and timers", personas: ["executive", "ops", "hr", "field"], badge: { endpoint: "/api/my-tasks" }, desktopPath: "/tasks" },
  ...
  { path: "/m/stock-out", title: "Move Stock", parent: "/m/inventory", kind: "list", module: "inventory", perm: "stock.issue", icon: ArrowLeftRight, hint: "Transfer or issue stock", personas: ["executive", "ops", "procurement", "field"], desktopPath: "/stock" },
  ...
  { path: "/m/transfers/[id]", title: "Transfer Detail", parent: "/m/stock", kind: "detail", module: "inventory", perm: "inventory.view", icon: Package, flowId: "stockTransfer", desktopPath: "/transfers" },

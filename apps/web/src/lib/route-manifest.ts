...
export const ROUTES: RouteEntry[] = [
  ...
  { path: "/m/dev", title: "Dev Tools", parent: "/m/settings", kind: "tool", module: "settings", perm: "audit.view", icon: Bug, redirectTo: "/m/dev/errors", hidden: true },
  ...
  { path: "/m/dprs/[id]", title: "Daily Progress Report Detail", parent: "/m/dprs", kind: "detail", module: "home", perm: "dpr.view", icon: ClipboardList, flowId: "dpr" },
  ...
  { path: "/m/pulse/approvals", title: "Approvals", parent: "/m/pulse", kind: "list", module: "home", icon: ClipboardCheck, hint: "POs, requisitions awaiting sign-off", redirectTo: "/m/approvals" },
  ...
  { path: "/m/site/attendance", title: "Mark Attendance", parent: "/m/site", kind: "tool", module: "home", perm: "hr.view", icon: Calendar, hint: "Bulk check-in with GPS", personas: ["executive", "ops", "hr", "field"] },
  { path: "/m/site/dpr", title: "New DPR", parent: "/m/site", kind: "tool", module: "home", perm: "dpr.view", icon: ClipboardList, hint: "Submit a new daily progress report", personas: ["executive", "ops", "hr", "field"] },
  { path: "/m/site/field", title: "Receive", parent: "/m/site", kind: "tool", module: "home", perm: "procurement.view", icon: Package, hint: "Barcode receiving with offline queue and qty validation" },

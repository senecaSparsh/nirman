...
export const ROUTES: RouteEntry[] = [
  ...
  { path: "/m/petty-cash", title: "Petty Cash", parent: "/m/expenses-hub", kind: "list", module: "home", perm: "finance.view", icon: Home, hint: "Site/office cash floats — top-ups and balances", desktopPath: "/petty-cash", keywords: ["petty cash", "float", "cash", "imprest"], sharesListWith: ["/m/accounts"] },
  ...
  { path: "/m/supplier-payments", title: "Supplier Payments", parent: "/m/expenses-hub", kind: "list", module: "home", perm: "finance.view", icon: Home, hint: "Record and track all supplier payments — cheques, bank transfers, TDS", desktopPath: "/supplier-payments", keywords: ["supplier payment", "vendor payment", "cheque", "bank transfer", "tds", "ap payment"], sharesListWith: ["/m/accounts"] },

...
export const ROUTES: RouteEntry[] = [
  ...
  { path: "/m/books/reports", title: "Analytics", parent: "/m/accounts", kind: "list", module: "accounts", perm: "finance.view", icon: TrendingUp, hint: "Key metrics at a glance", personas: ["executive", "ops", "finance"] },
  { path: "/m/boq", title: "Bill of Quantities", parent: "/m/inventory", kind: "list", module: "inventory", perm: "boq.view", icon: Boxes, hint: "Bill of Quantities — the project cost budget, item by item", desktopPath: "/boq", keywords: ["bill of quantities", "boq", "estimate", "budget", "rate analysis", "quantity survey"] },
  { path: "/m/boq/[id]", title: "BOQ Item", parent: "/m/boq", kind: "detail", module: "inventory", perm: "boq.view", icon: Boxes },
  { path: "/m/brokers", title: "Brokers", parent: "/m/home", kind: "list", module: "home", perm: "sales.view", icon: Home, hint: "Real estate brokers/agents — default commission %, contact info, deal history", desktopPath: "/brokers", keywords: ["broker", "agent", "commission", "deal source", "middleman", "referral"], sharesListWith: ["/m/real-estate"] },
  { path: "/m/brokers/new", title: "New Broker", parent: "/m/brokers", kind: "create", module: "home", perm: "sales.manage", icon: Home },
  { path: "/m/budget-variance", title: "Budget Variance", parent: "/m/inventory", kind: "list", module: "inventory", perm: "project_control.view", icon: TrendingUp, hint: "Budget vs actual analysis", desktopPath: "/budget-variance", personas: ["executive", "ops", "field"], keywords: ["budget", "variance", "boq vs actual", "overrun", "cost control"] },
  { path: "/m/budget-variance/[id]", title: "Budget Variance", parent: "/m/budget-variance", kind: "detail", module: "inventory", perm: "project_control.view", icon: TrendingUp },
  ...
  { path: "/m/change-orders", title: "Change Orders", parent: "/m/inventory", kind: "list", module: "inventory", perm: "projects.view", icon: Boxes, hint: "Formal modifications to project scope, BOQ, budget, and schedule with approval workflow", desktopPath: "/change-orders", keywords: ["change order", "scope change", "variation", "modification", "addition", "deletion", "budget change", "schedule change"], sharesListWith: ["/m/construction"] },
  { path: "/m/change-orders/[id]", title: "Change Order", parent: "/m/change-orders", kind: "detail", module: "inventory", perm: "projects.view", icon: Boxes },
  { path: "/m/construction", title: "Construction", parent: "/m/inventory", kind: "hub", module: "inventory", perm: "projects.view", icon: Wrench, hint: "Subcontractor scope & RA bills", personas: ["executive", "ops", "field"], sharesListWith: ["/m/change-orders", "/m/quality-control", "/m/work-orders"] },
  { path: "/m/crm", title: "CRM", parent: "/m/home", kind: "hub", module: "home", perm: "sales.view", icon: Users, hint: "Leads, calls, customers in one place", personas: ["executive", "ops", "sales"] },
  { path: "/m/customers", title: "Customers", parent: "/m/home", kind: "list", module: "home", perm: "sales.view", icon: Users, hint: "Buyers and tenants — contacts, bookings, and payments", sharesListWith: ["/m/leads"] },
  ...
  { path: "/m/expense-claims", title: "Expense Claims", parent: "/m/home", kind: "list", module: "home", perm: "finance.view", icon: Home, hint: "Employee reimbursement claims — submit, approve, and pay out", desktopPath: "/expense-claims", keywords: ["claim", "reimbursement", "employee expense", "travel", "site expense"], sharesListWith: ["/m/accounts"] },
  { path: "/m/expense-claims/[id]", title: "Expense Claim", parent: "/m/expense-claims", kind: "detail", module: "home", perm: "finance.view", icon: Home },
  { path: "/m/expenses", title: "Expenses", parent: "/m/accounts", kind: "list", module: "accounts", perm: "finance.view", icon: BookOpen, hint: "Book and approve operating expenses — categories, payment mode, GST, receipts, and approval workflow", desktopPath: "/expenses", keywords: ["expense", "spend", "opex", "voucher", "bill", "reimbursement", "petty cash", "approval"], sharesListWith: ["/m/accounts"] },
  ...
  { path: "/m/material-issues/[id]", title: "Material Issue", parent: "/m/material-issues", kind: "detail", module: "home", perm: "inventory.view", icon: Home },
  ...
  { path: "/m/material-sales", title: "Material Sales", parent: "/m/inventory", kind: "list", module: "inventory", perm: "sales.view", icon: TrendingUp, hint: "Sell raw material directly", flowId: "materialSale", desktopPath: "/material-sales", personas: ["executive", "ops", "procurement", "field"], keywords: ["surplus", "scrap", "resale", "material sale", "cost recovery", "by-product"] },
  { path: "/m/material-sales/[id]", title: "Material Sale", parent: "/m/material-sales", kind: "detail", module: "inventory", perm: "sales.view", icon: TrendingUp, flowId: "materialSale" },
  { path: "/m/material-sales/new", title: "New Material Sale", parent: "/m/material-sales", kind: "create", module: "inventory", perm: "sales.manage", icon: TrendingUp },
  ...
  { path: "/m/measurement-book", title: "Measurement Book", parent: "/m/inventory", kind: "list", module: "inventory", perm: "mb.view", icon: Boxes, hint: "Site engineer's verified record of actual quantities executed", desktopPath: "/measurement-book", keywords: ["mb", "measurement", "quantity", "site", "executed", "verified", "approved"] },
  { path: "/m/measurement-book/[id]", title: "Measurement Entry", parent: "/m/measurement-book", kind: "detail", module: "inventory", perm: "mb.view", icon: Boxes },
  ...
  { path: "/m/petty-cash", title: "Petty Cash", parent: "/m/home", kind: "list", module: "home", perm: "finance.view", icon: Home, hint: "Site/office cash floats — top-ups and balances", desktopPath: "/petty-cash", keywords: ["petty cash", "float", "cash", "imprest"], sharesListWith: ["/m/accounts"] },
  { path: "/m/portal-listings", title: "Portal Listings", parent: "/m/inventory", kind: "list", module: "inventory", perm: "sales.view", icon: TrendingUp, hint: "99acres, MagicBricks sync", personas: ["executive", "ops", "sales"] },
  { path: "/m/portal-listings/[id]", title: "Portal Listing", parent: "/m/portal-listings", kind: "detail", module: "inventory", icon: TrendingUp },
  { path: "/m/portal-listings/new", title: "New Portal Listing", parent: "/m/portal-listings", kind: "create", module: "inventory", perm: "sales.manage", icon: TrendingUp },
  { path: "/m/procurement", title: "POs", parent: "/m/inventory", kind: "hub", module: "inventory", perm: "procurement.view", icon: FileText, hint: "What you've ordered, from whom, and what's still to arrive at site", flowId: "procurement", desktopPath: "/procurement", personas: ["executive", "ops", "procurement", "field"], keywords: ["po", "order", "buy", "procure", "procurement", "purchase order"], badge: { endpoint: "/api/purchase-orders?status=DRAFT" } },
  ...
  { path: "/m/profit-center", title: "Profit Center", parent: "/m/accounts", kind: "list", module: "accounts", perm: "finance.view", icon: TrendingUp, hint: "Per-project revenue, cost, margin", desktopPath: "/profit-center", personas: ["executive", "finance", "ops"], keywords: ["profit", "loss", "pnl", "margin", "revenue", "cost per sqft", "job costing"] },
  { path: "/m/project-control", title: "Project Control", parent: "/m/inventory", kind: "list", module: "inventory", perm: "project_control.view", icon: Gauge, hint: "Earned value: CPI, SPI, EAC", desktopPath: "/project-control", personas: ["executive", "ops", "field"], keywords: ["evm", "earned value", "cpi", "spi", "cost overrun", "forecast", "commitment", "take off", "mto"] },
  ...
  { path: "/m/quotations", title: "Quotations", parent: "/m/inventory", kind: "redirect", module: "inventory", icon: Boxes, hint: "Collect supplier quotes, compare per-piece landed cost (with auto GST), and approve the winner", redirectTo: "/m/procurement?tab=quotations", desktopPath: "/quotations", keywords: ["quote", "quotation", "vendor quote", "comparative", "rate", "price", "tender", "bid", "hsn", "gst", "landed cost", "per piece"] },
  { path: "/m/quotations/[id]", title: "Quotation Detail", parent: "/m/procurement", kind: "redirect", module: "inventory", icon: FileText, redirectTo: "/m/quotations?open=${id}" },
  { path: "/m/quotations/new", title: "New Quotation", parent: "/m/procurement", kind: "redirect", module: "inventory", icon: FileText, redirectTo: "/m/procurement?tab=quotations&new=1" },
  { path: "/m/rate-contracts", title: "Rate Contracts", parent: "/m/inventory", kind: "list", module: "inventory", perm: "procurement.view", icon: FileText, hint: "Fixed-rate supplier agreements", desktopPath: "/rate-contracts", personas: ["executive", "ops", "procurement", "field"], keywords: ["rate contract", "framework agreement", "fixed rate", "supplier agreement"] },
  { path: "/m/rate-contracts/[id]", title: "Rate Contract", parent: "/m/rate-contracts", kind: "detail", module: "inventory", perm: "procurement.view", icon: FileText },
  ...
  { path: "/m/rent", title: "Rent", parent: "/m/home", kind: "redirect", module: "home", icon: Home, redirectTo: "/m/real-estate?tab=rentals" },
  { path: "/m/rentals", title: "Rentals", parent: "/m/home", kind: "list", module: "home", perm: "rentals.view", icon: Home, hint: "Units you've rented out and the rent due each month", desktopPath: "/rentals", keywords: ["lease", "tenant", "rent", "monthly", "leave and license"], sharesListWith: ["/m/real-estate"] },
  { path: "/m/rentals/[id]", title: "Rental Detail", parent: "/m/rentals", kind: "detail", module: "home", perm: "rentals.view", icon: Home },
  ...
  { path: "/m/reports/issue-register", title: "Issue Register", parent: "/m/reports", kind: "report", module: "home", perm: "inventory.view", icon: FileText, hint: "All stock issue slips", desktopPath: "/reports/issue-register", personas: ["executive", "ops", "procurement", "finance"], keywords: ["issue slip", "issue register", "sa", "stock issue summary", "material issue"] },
  { path: "/m/reports/job-costing", title: "Job Costing", parent: "/m/reports", kind: "report", module: "home", perm: "finance.view", icon: FileText, hint: "Per-project cost breakdown", desktopPath: "/reports/job-costing", personas: ["executive", "ops", "finance"], keywords: ["job costing", "direct cost", "indirect cost", "overhead", "absorption", "cost accounting"] },
  { path: "/m/reports/payroll-expense", title: "Payroll Expense", parent: "/m/reports", kind: "report", module: "home", perm: "finance.view", icon: Wallet, hint: "Monthly payroll by trade/crew", desktopPath: "/reports/payroll-expense", personas: ["executive", "ops", "hr", "finance"], keywords: ["payroll", "wage", "labour cost", "salary expense", "labour"] },
  { path: "/m/reports/pending-payments", title: "Pending Payments", parent: "/m/reports", kind: "report", module: "home", perm: "finance.view", icon: Wallet, hint: "Overdue POs + receivables", desktopPath: "/reports/pending-payments", personas: ["executive", "ops", "finance"], keywords: ["receivable", "payable", "outstanding", "overdue", "dues", "pending payment"] },
  ...
  { path: "/m/reports/purchase-register", title: "Purchase Register", parent: "/m/reports", kind: "report", module: "home", perm: "procurement.view", icon: FileText, hint: "Direct purchases + returns", desktopPath: "/reports/purchase-register", personas: ["executive", "ops", "procurement", "finance"], keywords: ["purchase register", "bill register", "p-register", "return register", "purchase bill"] },
  ...
  { path: "/m/reports/tds-certificates", title: "TDS Certificates", parent: "/m/reports", kind: "report", module: "home", perm: "finance.view", icon: FileText, hint: "Subcontractor TDS tracking", desktopPath: "/reports/tds-certificates", personas: ["executive", "ops", "finance"], keywords: ["tds", "certificate", "194c", "form 16c", "subcontractor", "tax deducted", "tds certificate"] },
  { path: "/m/requisitions", title: "Material Indents", parent: "/m/inventory", kind: "redirect", module: "inventory", icon: Boxes, hint: "Site raises an indent for material. Approve it, then convert it to a purchase order", redirectTo: "/m/procurement?tab=indents", desktopPath: "/requisitions", keywords: ["indent", "requisition", "request", "ask", "demand", "material request"] },
  ...
  { path: "/m/scrap-generations", title: "Scrap", parent: "/m/inventory", kind: "redirect", module: "inventory", icon: Boxes, redirectTo: "/m/stock?tab=scrap" },
  { path: "/m/scrap-generations/[id]", title: "Scrap Entry", parent: "/m/stock", kind: "detail", module: "inventory", perm: "inventory.view", icon: Package },
  ...
  { path: "/m/stock-counts", title: "Stock Inventory", parent: "/m/inventory", kind: "redirect", module: "inventory", icon: Boxes, redirectTo: "/m/stock?tab=counts" },
  ...
  { path: "/m/subcontractors", title: "Subcontractors", parent: "/m/inventory", kind: "list", module: "inventory", perm: "projects.view", icon: HardHat, hint: "Subcontractor master, scope, RA bills", desktopPath: "/subcontractors", personas: ["executive", "ops", "field"], keywords: ["subcontractor", "contractor", "vendor", "trade", "masonry", "plumbing", "electrical", "194c"] },
  { path: "/m/subcontractors/[id]", title: "Subcontractor Detail", parent: "/m/subcontractors", kind: "detail", module: "inventory", perm: "projects.view", icon: HardHat },
  { path: "/m/subcontractors/new", title: "New Subcontractor", parent: "/m/subcontractors", kind: "create", module: "inventory", perm: "projects.manage", icon: HardHat },
  { path: "/m/supplier-payments", title: "Supplier Payments", parent: "/m/home", kind: "list", module: "home", perm: "finance.view", icon: Home, hint: "Record and track all supplier payments — cheques, bank transfers, TDS", desktopPath: "/supplier-payments", keywords: ["supplier payment", "vendor payment", "cheque", "bank transfer", "tds", "ap payment"], sharesListWith: ["/m/accounts"] },
  { path: "/m/supplier-payments/new", title: "New Supplier Payment", parent: "/m/supplier-payments", kind: "create", module: "home", perm: "finance.manage", icon: Home },
  { path: "/m/supplier-returns", title: "Supplier Returns", parent: "/m/inventory", kind: "redirect", module: "inventory", icon: Boxes, hint: "Send defective or excess stock back to a supplier and track the debit note", redirectTo: "/m/procurement?tab=returns", desktopPath: "/supplier-returns", keywords: ["return", "debit note", "credit note", "defective", "reject", "send back", "purchase return"] },
  { path: "/m/supplier-returns/[id]", title: "Supplier Return", parent: "/m/procurement", kind: "detail", module: "inventory", perm: "procurement.view", icon: FileText },
  { path: "/m/supplier-returns/new", title: "New Supplier Return", parent: "/m/procurement", kind: "create", module: "inventory", perm: "procurement.manage", icon: FileText },
  { path: "/m/suppliers", title: "Suppliers", parent: "/m/inventory", kind: "list", module: "inventory", perm: "procurement.view", icon: Truck, hint: "Vendors, balances", desktopPath: "/suppliers", personas: ["executive", "ops", "procurement", "field"], keywords: ["vendor", "seller", "party", "supplier", "vendor rating", "supplier score", "performance", "on-time", "quality", "price"] },
  { path: "/m/suppliers/[id]", title: "Supplier Detail", parent: "/m/suppliers", kind: "detail", module: "inventory", perm: "procurement.view", icon: Truck },
  { path: "/m/suppliers/new", title: "New Supplier", parent: "/m/suppliers", kind: "create", module: "inventory", perm: "procurement.manage", icon: Truck },
  { path: "/m/telephony", title: "Telephony", parent: "/m/home", kind: "list", module: "home", perm: "telephony.view", icon: Phone, hint: "Phone numbers, providers, consent", desktopPath: "/telephony", personas: ["executive"], keywords: ["telephony", "phone number", "call recording", "exotel", "knowlarity", "twilio", "consent", "ivr", "virtual number"] },
  { path: "/m/transfers", title: "Transfers", parent: "/m/inventory", kind: "redirect", module: "inventory", icon: Boxes, redirectTo: "/m/stock?tab=transfers" },
  ...
  { path: "/m/units", title: "Built Units", parent: "/m/inventory", kind: "list", module: "inventory", perm: "assets.view", icon: Boxes, hint: "Flats, shops, plots — what's available, booked, or sold (renovations + portal listings tabs inside)", flowId: "builtUnit", desktopPath: "/units", keywords: ["flat", "shop", "apartment", "unit", "available", "stock", "inventory", "99acres", "magicbricks", "housing.com", "portal", "listing", "property", "sync", "marketplace", "renovation", "addition", "improvement", "refurbish", "value add", "repair"], sharesListWith: ["/m/real-estate"] },
  { path: "/m/units/[id]", title: "Built Unit", parent: "/m/units", kind: "detail", module: "inventory", perm: "assets.view", icon: Boxes },
  ...
  { path: "/m/wbs", title: "Work Breakdown Structure", parent: "/m/inventory", kind: "list", module: "inventory", perm: "wbs.view", icon: Boxes, hint: "Work Breakdown Structure — activities, dependencies, critical path", desktopPath: "/wbs", keywords: ["wbs", "schedule", "gantt", "critical path", "dependency", "milestone", "activity"] },
  { path: "/m/wbs/[id]", title: "WBS Node", parent: "/m/wbs", kind: "detail", module: "inventory", perm: "wbs.view", icon: Boxes },
  { path: "/m/work-orders", title: "Work Orders", parent: "/m/inventory", kind: "list", module: "inventory", perm: "projects.view", icon: Boxes, hint: "Subcontractor work orders and RA bills with TDS and retention", desktopPath: "/work-orders", keywords: ["subcontractor", "work order", "ra bill", "running account", "tds", "retention", "contractor"], sharesListWith: ["/m/construction"] },
  { path: "/m/work-orders/[id]", title: "Work Order", parent: "/m/work-orders", kind: "detail", module: "inventory", perm: "projects.view", icon: Boxes },
...
export function menuGroupsFor(ctx: NavContext): Record<string, MenuGroup[]> {
  ...
  for (const section of sections) {
    ...
    for (const [parentPath, routes] of byParent) {
      ...
      const kindOrder: Record<string, number> = { hub: 0, list: 1, report: 2, tool: 3 };
      routes.sort((a, b) => (kindOrder[a.kind] ?? 9) - (kindOrder[b.kind] ?? 9));

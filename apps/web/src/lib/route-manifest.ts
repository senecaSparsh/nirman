...
export const ROUTES: RouteEntry[] = [
  ...
  { path: "/m/approvals", title: "Approvals", parent: "/m/home", kind: "list", module: "home", perm: "po.approve", icon: ClipboardCheck, hint: "POs, requisitions, gate passes, and DPRs awaiting your sign-off", desktopPath: "/approvals", keywords: ["approval", "pending", "queue", "sign off", "review", "approve", "reject", "po", "requisition", "gate pass", "dpr"] },
  ...
  { path: "/m/pulse/approvals", title: "Approvals", parent: "/m/pulse", kind: "list", module: "home", perm: "po.approve", icon: ClipboardCheck, hint: "POs, requisitions awaiting sign-off", redirectTo: "/m/approvals" },

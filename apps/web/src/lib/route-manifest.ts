...
export const ROUTES: RouteEntry[] = [
  ...
  { path: "/m/reports/purchase-register", title: "Purchase Register", parent: "/m/reports", kind: "report", module: "home", perm: "procurement.view", icon: ScrollText, hint: "Direct purchases + returns", desktopPath: "/reports/purchase-register", personas: ["executive", "ops", "procurement", "finance"], keywords: ["purchase register", "bill register", "p-register", "return register", "purchase bill"] },
  ...
  { path: "/m/requisitions/[id]", title: "Material Indent", parent: "/m/procurement", kind: "detail", module: "inventory", perm: "procurement.view", icon: Inbox, flowId: "requisition" },
  { path: "/m/requisitions/new", title: "New Material Indent", parent: "/m/procurement", kind: "create", module: "inventory", perm: "procurement.manage", icon: Inbox },
  ...
  { path: "/m/supplier-returns/[id]", title: "Supplier Return", parent: "/m/procurement", kind: "detail", module: "inventory", perm: "procurement.view", icon: Undo2 },
  { path: "/m/supplier-returns/new", title: "New Supplier Return", parent: "/m/procurement", kind: "create", module: "inventory", perm: "procurement.manage", icon: Undo2 },

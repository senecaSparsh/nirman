...
export const PERM = {
  ...
  // Self-service reimbursement claims — any staff member can file their
  // own claim; narrower than expense.create (which books company spend).
...
export const PERMISSION_MODULES: {
  ...
  },
  {
    ...
    label: "Finance & Books",
    icon: "Calculator",
    permissions: [PERM.FINANCE_VIEW, PERM.FINANCE_MANAGE, PERM.EXPENSE_CREATE, PERM.EXPENSE_APPROVE, PERM.CLAIM_CREATE],
  },
  {
    key: "sales",
    label: "Sales",
...
export const ROLES: Record<Role, RoleDef> = {
  ...
  PROJECT_DIRECTOR: {
    ...
    permissions: [
      ...
      PERM.INVENTORY_VIEW,
      PERM.PROCUREMENT_VIEW, PERM.PROCUREMENT_MANAGE, PERM.PO_APPROVE, PERM.REQUISITION_CREATE, PERM.REQUISITION_APPROVE,
      ...
      PERM.FINANCE_VIEW, PERM.CLAIM_CREATE,
      PERM.HR_VIEW, PERM.DPR_VIEW, PERM.DPR_APPROVE_SUB_ADMIN, PERM.DPR_APPROVE_ADMIN,
  ...
  FINANCE_HEAD: {
    ...
    permissions: [
      PERM.FINANCE_VIEW, PERM.FINANCE_MANAGE, PERM.EXPENSE_CREATE, PERM.EXPENSE_APPROVE, PERM.CLAIM_CREATE,
      PERM.PROJECTS_VIEW,
  ...
  PROJECT_MANAGER: {
    ...
    permissions: [
      ...
      PERM.FINANCE_VIEW, PERM.EXPENSE_CREATE, PERM.CLAIM_CREATE,
  ...
  HR_MANAGER: {
    ...
    permissions: [
      PERM.HR_VIEW, PERM.HR_MANAGE, PERM.CLAIM_CREATE,
  ...
  SITE_ENGINEER: {
    ...
    permissions: [
      ...
      PERM.PROCUREMENT_VIEW, PERM.REQUISITION_CREATE,
      PERM.QUOTATION_VIEW,
      PERM.ASSETS_VIEW, PERM.RENTALS_VIEW,
      PERM.BOQ_VIEW, PERM.WBS_VIEW, PERM.MB_VIEW, PERM.MB_VERIFY, PERM.PROJECT_CONTROL_VIEW,
      PERM.HR_VIEW, PERM.ATTENDANCE_LOG, PERM.DPR_VIEW, PERM.DPR_SUBMIT,
      PERM.TASKS_VIEW, PERM.CLAIM_CREATE,
      PERM.VEHICLE_VIEW,
  ...
  ACCOUNTANT: {
    ...
    permissions: [
      PERM.FINANCE_VIEW, PERM.FINANCE_MANAGE, PERM.EXPENSE_CREATE, PERM.CLAIM_CREATE,
      PERM.PROJECTS_VIEW,
      PERM.PROCUREMENT_VIEW,
      PERM.QUOTATION_VIEW,
      PERM.SALES_VIEW,
  ...
  SALES_MANAGER: {
    ...
    permissions: [
      PERM.SALES_VIEW, PERM.SALES_MANAGE, PERM.SALE_CREATE, PERM.CLAIM_CREATE,

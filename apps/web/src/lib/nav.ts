...
export const EVERYONE = [
  ...
  "SUPERVISOR", "QAQC_ENGINEER", "SECURITY_GUARD",
];
      ...
      // ── Construct ──────────────────────────────────────────────
      {
        ...
        items: [
          ...
          },
          {
            ...
            href: "/cost-control",
            icon: TrendingUp,
            hint: "Project control (EVM), budget variance, and profit center analysis — all in one place",
            roles: [...LEADERSHIP, ...BOOKS],
            keywords: ["cost control", "evm", "earned value", "cpi", "spi", "cost overrun", "forecast", "commitment", "take off", "mto", "budget", "variance", "boq vs actual", "overrun", "profit", "loss", "pnl", "margin", "revenue", "cost per sqft", "job costing"],
            hidden: true,
            group: RG.CONSTRUCT,
          },
        ],
        ...
        items: [
          {
            ...
            href: "/finance",
            icon: Wallet,
            hint: "Expenses, claims, petty cash, recurring expenses, budgets, supplier payments, project costs — all in one place",
            roles: BOOKS,
            keywords: ["cash", "expense", "payment", "cost", "spend", "finance", "claim", "reimbursement", "petty cash", "float", "recurring", "rent", "salary", "amc", "budget", "variance", "supplier payment", "vendor payment", "cheque", "tds"],
          },
          {
...
export const SETTINGS_LINKS: NavLink[] = [
  ...
  {
    label: "Telephony",
    href: "/calls?tab=telephony",
    icon: Phone,
    hint: "Company phone numbers, call recording config, telephony providers, and call monitoring consent policy (tab inside Calls)",
    roles: OWNERS,

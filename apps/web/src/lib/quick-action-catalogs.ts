...
export const HR_QUICK_ACTIONS: QuickActionTab[] = [
  ...
  },
  {
    ...
    actions: [
      ...
      { key: "crews", href: "/m/hr/employees", icon: Users, label: "Team", personas: ["field", "ops", "hr"] },
      { key: "approvals", href: "/m/approvals", icon: ClipboardCheck, label: "Approvals", personas: ["hr", "ops", "executive"] },
    ],
  },
];
...
export const ACCOUNTS_QUICK_ACTIONS: QuickActionTab[] = [
  {
    ...
    actions: [
      ...
      { key: "payroll", href: "/m/books/payroll", icon: Wallet, label: "Payroll", personas: ["finance", "hr", "executive"] },
